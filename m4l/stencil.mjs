// Stencil n4m entry. Thin wrapper over TmBridge — wires the Max API
...
// - This file MUST live at `m4l/stencil.mjs` (NOT under host/),
...
//   empirically: a [node.script] with `host/index.mjs` as filename
